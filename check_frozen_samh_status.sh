...
for spec in \
  ...
  OUT="${ROOT}/outputs/stamp_official_samh_${MODEL}_${SAFE_SPLIT}"
...
echo "Combined summary: $([[ -f "${ROOT}/outputs/stamp_official_samh_full_comparison/combined_summary.md" ]] && echo yes || echo no)"
echo
