...
OUT_DIR="${OUT_DIR:-${MLLM_SEG_ROOT}/outputs/stamp_online_token_refine_B_2gpu}"
...
export MODEL_NAME
export OUT_DIR
export STAMP_ONLINE_TOKEN_REFINE="${STAMP_ONLINE_TOKEN_REFINE:-1}"
export STAMP_FREEZE_FOR_ONLINE_REFINE="${STAMP_FREEZE_FOR_ONLINE_REFINE:-1}"
export STAMP_REFINE_CALIBRATE="${STAMP_REFINE_CALIBRATE:-1}"
export STAMP_REFINE_USE_GATE="${STAMP_REFINE_USE_GATE:-0}"
export STAMP_REFINE_HIDDEN_SIZE="${STAMP_REFINE_HIDDEN_SIZE:-128}"
export STAMP_REFINE_UNCERTAINTY_WEIGHT="${STAMP_REFINE_UNCERTAINTY_WEIGHT:-2.0}"
export STAMP_REFINE_DELTA_REG="${STAMP_REFINE_DELTA_REG:-0.01}"
...
echo "Online token refine B training:"
